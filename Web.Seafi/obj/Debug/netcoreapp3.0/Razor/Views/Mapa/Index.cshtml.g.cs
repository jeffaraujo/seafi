#pragma checksum "C:\Users\jeffa\source\repos\seafi\Web.Seafi\Views\Mapa\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8cab3f787217048957e3b051969b7c6653cb0674"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8cab3f787217048957e3b051969b7c6653cb0674", @"/Views/Mapa/Index.cshtml")]
...
<script src=""https://maps.googleapis.com/maps/api/js?key=AIzaSyA_A2z7ohEi0oqOvayhw0fNmMoch_uMhEo""></script>
<div id=""mapDiv""></div>
<script type=""text/javascript"">
    var draw_circle = null;  //Redesenhando o objeto c�rculo no primeiro refresh
    function DisplayGoogleMap() {
        ...
        v");
            WriteLiteral(@"ar longitude004 = -46.06842041015626;
        ...
        var PontoPrincipal = new google.maps.LatLng(latitudePrincipal, longitudePrincipal); //N�o usado no MVP0
        var Ponto001 = new google.maps.LatLng(latitude001, longitude001);
        var Ponto002 = new google.maps.LatLng(latitude002, longitude002);
        var Ponto003 = new google.maps.LatLng(latitud");
            WriteLiteral(@"e003, longitude003);
        var Ponto004 = new google.maps.LatLng(latitude004, longitude004);
        var Ponto005 = new google.maps.LatLng(latitude005, longitude005);
        var Ponto006 = new google.maps.LatLng(latitude006, longitude006);
        var Ponto007 = new google.maps.LatLng(latitude007, longitude007);
        var Ponto008 = new google.maps.LatLng(latitude008, longitude008);
        var Ponto009 = new google.maps.LatLng(latitude009, longitude009);
        var Ponto010 = new google.maps.LatLng(latitude010, longitude010);
        var Ponto011 = new google.maps.LatLng(latitude011, longitude011);

        //Op��es iniciais do Google Maps
        var mapOptions = {
        ...
        let url = ""http://maps.google.com/m");
            WriteLiteral(@"apfiles/kml/pal4/icon61.png"" //Endere�o do �cone
        let urlDesativado = ""http://maps.google.com/mapfiles/kml/pal4/icon53.png"" //N�o usado


        //Configurando a msg do bal�o (N�o usado no MVP0)
        var contentStringPrincipal = '<div id=""content"">'+
                              ...
                              '</div>'+
                              '</div>';
        var infowindowPrincipal = new google.maps.InfoWindow({
            content: contentStringPrincipal
        });

        //Configurando a msg do bal�o
        var c");
            WriteLiteral(@"ontentString001 = '<div id=""content"">'+
                              '<div id=""siteNotice"">'+
                              '</div>'+
                              ...
                              '</div>'+
                              '</div>';
        var infowindow001 = new google.maps.InfoWindow({
        ...
        var contentString002 = '<div id=""content"">'+
                           ...
                           ");
            WriteLiteral(@"   '<div id=""bodyContent"">'+
                              '<p><b>Latitude:</b>' + latitude002 + '</p>' +
                              '<p><b>Longitude:</b>' + longitude002 + '</p>' +
                              '<p><b>Status:</b> Em funcionamento</p>' +
                              '</div>'+
                              '</div>';
        var infowindow002 = new google.maps.InfoWindow({
        ...
        //Configurando a msg do bal�o
         var contentString003 = '<div id=""content"">'+
            ...
            WriteLiteral(@">' +
                              '</div>'+
                              '</div>';
        var infowindow003 = new google.maps.InfoWindow({
        ...
        //Configurando a msg do bal�o
         var contentString004 = '<div id=""content"">'+
                              ...
                              '</div>'+
                              '</div>';
        var infowindow004 = new google.maps.InfoWindow({
        ...
        //Configurando a msg do bal�o
         var ");
            WriteLiteral(@"contentString005 = '<div id=""content"">'+
                              '<div id=""siteNotice"">'+
                              '</div>'+
                              ...
                              '</div>'+
                              '</div>';
        var infowindow005 = new google.maps.InfoWindow({
        ...
        var contentString006 = '<div id=""content"">'+
            ...
            WriteLiteral(@"  '<div id=""bodyContent"">'+
                              ...
                              '</div>'+
                              '</div>';
        var infowindow006 = new google.maps.InfoWindow({
        ...
        //Configurando a msg do bal�o
         var contentString007 = '<div id=""content"">'+
            ...
            WriteLiteral(@"+
                              '</div>'+
                              '</div>';
        var infowindow007 = new google.maps.InfoWindow({
        ...
        var contentString008 = '<div id=""content"">'+
                              ...
                              '</div>'+
                              '</div>';
        var infowindow008 = new google.maps.InfoWindow({
            content: contentString008
        });

        //Configurando a msg do bal�o
        var contentStri");
            WriteLiteral(@"ng009 = '<div id=""content"">'+
                              '<div id=""siteNotice"">'+
                              '</div>'+
                              ...
                              '</div>'+
                              '</div>';
        var infowindow009 = new google.maps.InfoWindow({
        ...
        //Configure o maker (N�o usado no MVP0)
        ...
        //Evento clique para aparecer o bal�o (N�o usado no MVP0)
        ...
        //Evento clique para aparecer o bal�o
        marker001.addListener('click', function() {
            infowi");
            WriteLiteral(@"ndow001.open(map, marker001);
        });
        ...
        marker006.addListener('click', function() {
            infowindow006.open(map, ");
            WriteLiteral(@"marker006);
        });
        //Configure o maker
   ...
   ");
    ...
    ");
            WriteLiteral(@"    marker001.setMap(map);
